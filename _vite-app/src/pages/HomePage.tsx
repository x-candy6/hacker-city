...
export default function HomePage() {
  const articleCards = mockArticles.map(prepareArticleCard);
  const [featured, ...rest] = articleCards;
  const miniArticles = rest.slice(0, 3);

  const techArticles = articleCards.filter((a: typeof articleCards[number]) => a.article.category === 'technology').slice(0, 3);
  const businessArticles = articleCards.filter((a: typeof articleCards[number]) => a.article.category === 'business').slice(0, 3);
  const cultureArticles = articleCards.filter((a: typeof articleCards[number]) => a.article.category === 'culture').slice(0, 3);
  const earthArticles = articleCards.filter((a: typeof articleCards[number]) => a.article.category === 'earth').slice(0, 3);
  const healthArticles = articleCards.filter((a: typeof articleCards[number]) => a.article.category === 'health').slice(0, 3);
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-4">
                {miniArticles.map((article: typeof articleCards[number]) => (
                  <Link key={article.article.id} to={article.href} className="group block">
            ...
            {techArticles[0] && (
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div className="order-2 lg:order-1">
                  <Link to={techArticles[0].href} className="group block">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            {businessArticles[0] && (
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                ...
                <div>
                  <Link to={businessArticles[0].href} className="group block">
                    <article className="petal-panel p-8">
        ...
        <div className="relative z-10 px-6 lg:px-12 py-16 lg:py-24">
          <div className="max-w-7xl mx-auto">
            ...
            {cultureArticles[0] && (
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div className="order-2 lg:order-1">
                  <Link to={cultureArticles[0].href} className="group block">
                    <article className="petal-panel p-8">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            {earthArticles[0] && (
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                ...
                <div>
                  <Link to={earthArticles[0].href} className="group block">
                    <article className="petal-panel p-8">
        ...
        <div className="relative z-10 px-6 lg:px-12 py-16 lg:py-24">
          <div className="max-w-7xl mx-auto">
            ...
            {healthArticles[0] && (
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div className="order-2 lg:order-1">
                  <Link to={healthArticles[0].href} className="group block">
                    <article className="petal-panel p-8">
        ...
        <div className="px-6 lg:px-12">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between mb-10">
              ...
              <Link to="/news" className="link-accent text-sm">
                View all
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <line x1="5" y1="12" x2="19" y2="12" />
                  <polyline points="12 5 19 12 12 19" />
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {articleCards.slice(3, 9).map((article: typeof articleCards[number]) => (
      ...
      <section className="py-16 lg:py-24 bg-[#F6F7FB]">
        <div className="px-6 lg:px-12">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="space-y-4">
              {articleCards.slice(0, 3).map((article: typeof articleCards[number], index: number) => (
                <Link key={article.article.id} to={article.href} className="group block">
        ...
        <div className="px-6 lg:px-12">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {siteConfig.categories.slice(0, 6).map((category: typeof siteConfig.categories[number]) => (
                <Link
                  key={category.slug}
                  to={`/${category.slug}`}
                ...
                >
                  <div className="petal-panel p-6 relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-24 h-24 opacity-20">
                      <BlossomSVG variant={Math.floor(Math.random() * 6) + 1 as 1|2|3|4|5|6} />
                    </div>
                    ...
                    <span className="meta-text mt-2 block relative z-10">
                      {mockArticles.filter((a: typeof mockArticles[number]) => a.category === category.slug).length} articles
                    </span>
                  </div>
                </Link>
              ))}
