        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            <div className="lg:col-span-1">
              <Link to="/" className="font-display font-black text-2xl tracking-tight text-white block mb-4">
                Hacker-City
              </Link>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/about" className="footer-link text-white/60 hover:text-white">
                    About
                  </Link>
                </li>
                <li>
                  <Link to="/careers" className="footer-link text-white/60 hover:text-white">
                    Careers
                  </Link>
                </li>
                <li>
                  <Link to="/contact" className="footer-link text-white/60 hover:text-white">
                    Contact
                  </Link>
                </li>
                <li>
                  <Link to="/advertise" className="footer-link text-white/60 hover:text-white">
                    Advertise
                  </Link>
                </li>
              </ul>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <Link to="/accessibility" className="text-white/40 text-sm hover:text-white transition-colors">
                Accessibility
              </Link>
            </div>
          </div>
